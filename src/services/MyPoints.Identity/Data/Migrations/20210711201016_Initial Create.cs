        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsExcluded = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "0"),
                    CreatedUser = table.Column<string>(type: "NVARCHAR(256)", nullable: true),
                    UpdatedUser = table.Column<string>(type: "NVARCHAR(256)", nullable: true),
                    CreatedDate = table.Column<DateTime>(nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedDate = table.Column<DateTime>(nullable: true, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedUser = table.Column<Guid>(nullable: true),
                    ...
                    Complements = table.Column<string>(type: "NVARCHAR(255)", nullable: true),
                    UserId = table.Column<Guid>(nullable: false)
                },
                constraints: table =>
                {
